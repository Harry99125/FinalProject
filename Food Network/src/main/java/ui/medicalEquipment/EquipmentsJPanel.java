...
public class EquipmentsJPanel extends javax.swing.JPanel {
    ...
    public EquipmentsJPanel(JPanel cardSequencePanel, MedicalEquipmentSupplier medicalEquipmentSupplier, MongoDatabase database, Business business) {
        initComponents();
    ...
    private void btnAddNewEquipmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNewEquipmentActionPerformed
        ...
        AddMedicalEquipmentJPanel addMedicalEquipmentJPanel = new AddMedicalEquipmentJPanel(cardSequencePanel, database, business);
        cardSequencePanel.add("AddMedicalEquipmentJPanel", addMedicalEquipmentJPanel);
