...
public class RequestedItemsJPanel extends javax.swing.JPanel {
    ...
    public RequestedItemsJPanel(JPanel cardSequencePanel, MedicalEquipmentSupplier medicalEquipmentSupplier, MongoDatabase databases, Business business) {
        initComponents();
...
//        find all the equipments that were requested for this supplier
    ...
    private void initComponents() {
        ...
        tblRequestedItems.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Equipment Name", "Equipment Purpose", "Hospital Name", "Hospital Location", "Status"
            }
        ));
