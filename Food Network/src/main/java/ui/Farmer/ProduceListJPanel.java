...
public class ProduceListJPanel extends javax.swing.JPanel {
    ...
    public ProduceListJPanel(JPanel cardSequencePanel, Business business, Farmer farmer, MongoDatabase prevdatabase) {
        initComponents();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        UpdateProduceJPanel updateProduceJPanel = new UpdateProduceJPanel(cardSequencePanel, business, farmer, null, database);
    ...
    private void btnGetDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetDetailsActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            // Pass the selected produce's name to the UpdateProduceJPanel
            UpdateProduceJPanel updateProduceJPanel = new UpdateProduceJPanel(cardSequencePanel, business, farmer, produceName, database);
    ...
    private void btnGetReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetReportActionPerformed
        ...
        FileSaver fileSaver = new FileSaver(tableProduceList, farmer.getFarmerName(), columnNames);
        fileSaver.saveFile();
