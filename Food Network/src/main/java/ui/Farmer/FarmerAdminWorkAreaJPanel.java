...
public class FarmerAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FarmerAdminWorkAreaJPanel
     */
   ...
   public FarmerAdminWorkAreaJPanel(JPanel cardSequencePanel, Farmer farmer, MongoDatabase database, Business business) {
    initComponents();
...
private void populateFarmerDetails() {
    ...
    txtFarmerEmail.setText(farmer.getFarmerEmail());
    txtFarmerManagerName.setText(farmer.getFarmerManagerName());
}
    ...
    private void btnFarmerListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFarmerListActionPerformed
        // TODO add your handling code here:
        ProduceListJPanel produceListJPanel = new ProduceListJPanel(FarmerCardLayout, business, farmer, database);
