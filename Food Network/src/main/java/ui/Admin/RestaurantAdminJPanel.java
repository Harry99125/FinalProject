...
public class RestaurantAdminJPanel extends javax.swing.JPanel {
    ...
    public RestaurantAdminJPanel(JPanel adminLayout, MongoDatabase database, Business business) {
        initComponents();
    ...
    private void populateTrainingCenterTable() {
        ...
        FindIterable<Document> RestaurantDetails = trainingCenterCollection.find();
        if(RestaurantDetails!=null){
        for (Document Restaurant : RestaurantDetails) {
            // Retrieve the corresponding farmer user document using FarmerAdminId
            Document RestaurantUser = crudOperations.getFirstRecordByKey("_id", new ObjectId(Restaurant.get("RestaurantAdminId").toString()), userCollection);

            // Add row data to the table model
            model.addRow(new Object[]{
                Restaurant.get("RestaurantName"),
               Restaurant.get("Restaurantlocation"),
                Restaurant.get("Restaurantcontact"),
                Restaurant.get("Restaurantemail"),
                RestaurantUser != null ? RestaurantUser.get("username") : "N/A" // Safeguard for missing user data
            });
