...
import ui.Farmer.ProduceListJPanel;
...
public class RetailerAdminWorkAreaJPanel extends javax.swing.JPanel {
   ...
   public RetailerAdminWorkAreaJPanel(JPanel cardSequencePanel, Retailer retailer, MongoDatabase database, Business business1) {
    initComponents();
    ...
    setFlag(false);
    // System.out.println(retailer.getId());
}

    RetailerAdminWorkAreaJPanel(JPanel AdminLayout, MongoDatabase database, Business business) {
...
private void populateFarmerDetails() {
    txtFarmerName.setText(retailer.getRetailerName());
    txtFarmerAddress.setText(retailer.getRetailerAddress());
    txtFarmerContact.setText(retailer.getRetailerContact());
    txtFarmerEmail.setText(retailer.getRetailerEmail());
    txtFarmerManagerName.setText(retailer.getRetailerManagerName());
}
    ...
    private void initComponents() {
        ...
        lblFarmerDetails.setText("RETAILER DETAILS");
        ...
        btnFarmerList.setText("Product List");
    ...
    private void btnFarmerListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFarmerListActionPerformed
        // TODO add your handling code here:
        RequestJPanel produceListJPanel = new RequestJPanel(FarmerCardLayout, business, retailer, database);
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHomeActionPerformed
        // TODO add your handling code here:
        RetailerAdminWorkAreaJPanel farmerAdminWorkAreaJPanel = new RetailerAdminWorkAreaJPanel(CardSequencePanel, retailer, database, business);
